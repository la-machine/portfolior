...
const ArchiveCard = ({title, des, listItems}:Props) => {
    return(
        ...
        justify-center gap-6 hover:translate-y-2 transition-transform duration-300 group">
            ...
            <div>
                ...
                <p className="text-xs mt-3">{des}
                </p>
            </div>
            <ul className="text-[300] mdl:text-xs text-textDark flex items-center gap-2 justify-between
            flex-wrap">
