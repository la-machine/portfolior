...
const GSC = () => {
    return(
        ...
        className="w-full">
            ...
            <span className="text-textGreen tracking-wide">@GSC</span></h3>
            <p className="text-sm mt-1 font-medium text-textDark">June 2022 - September 2022</p>
            <ul className="mt-6 flex flex-col gap-3">
                ...
                <li className="text-base flex gap-2 text-textDark">
                    <span className="text-textGreen mt-1"><TiArrowForward/> </span>
                    Collected and reviewed data to analyse system capabilities and development requirements
                </li>
                <li className="text-base flex gap-2 text-textDark">
                    <span className="text-textGreen mt-1"><TiArrowForward/> </span>
                ...
                <li className="text-base flex gap-2 text-textDark">
                    <span className="text-textGreen mt-1"><TiArrowForward/> </span>
                    Design Presentation in PowerPoint.
                </li>
            </ul>
        </motion.div>
    );
